...
PUBLICATIONS = [
    (
        ...
        [
            ["Paper", "http://granite.sru.edu/~pacise/proceedings/pacise-proceedings-2020.pdf#page=61"],
    ...
    (
        ...
        ["Alex Day", "Soo Kim"],
        [
            ["Paper", "http://granite.sru.edu/~pacise/proceedings/pacise-proceedings-2019.pdf#page=98"],
            ["Code", "https://github.com/AlexanderDavid/AutomaticExtractiveSummarization"]
        ]
    )
]
